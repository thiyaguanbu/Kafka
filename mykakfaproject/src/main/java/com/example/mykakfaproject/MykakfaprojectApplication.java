package com.example.mykakfaproject;
...
public class MykakfaprojectApplication {

	public static void main(String[] args) throws Exception {

		ConfigurableApplicationContext context = SpringApplication.run(MykakfaprojectApplication.class, args);
